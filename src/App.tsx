...
import { Mail, MapPin, Linkedin, Github, ExternalLink, Award, Code, User, GraduationCap, Briefcase, Lightbulb, Instagram, X, Menu, Phone } from 'lucide-react';
const App = () => {
    ...
    <div className="min-h-screen bg-slate-50 selection:bg-blue-100 selection:text-blue-900 font-sans">
      ...
      <section id="education" className="py-20 px-6 bg-white/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">Graduation: July 2027</span>
              </div>
      ...
      <section id="experience" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">September 2025 – March 2026</span>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">November 2025 – March 2026</span>
              </div>
              <ul className="text-slate-700 space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">January 2024 – Present</span>
              </div>
              <ul className="text-slate-700 space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">June 2025 – August 2025</span>
              </div>
              <ul className="text-slate-700 space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">June 2025 – July 2025</span>
              </div>
              <ul className="text-slate-700 space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">June 2024 – August 2024</span>
              </div>
              <ul className="text-slate-700 space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 flex flex-col h-full group">
              <div className="mb-4">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">Musician-Llama (GenAI)</h3>
                <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                  Fine-tuned the Llama-3.2-1B-Instruct Large Language Model to generate MIDI music files. Published the model and dataset on Hugging Face, including documentation for inference. Optimized the model to accept text instructions and output creative musical compositions.
                </p>
              </div>
              <div className="mt-auto pt-4 border-t border-slate-100">
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-xs font-medium border border-blue-100">GenAI</span>
                  <span className="px-3 py-1 bg-purple-50 text-purple-600 rounded-full text-xs font-medium border border-purple-100">LLM</span>
                  <span className="px-3 py-1 bg-yellow-50 text-yellow-600 rounded-full text-xs font-medium border border-yellow-100">HuggingFace</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 flex flex-col h-full group">
              <div className="mb-4">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">3D Campus Power Analysis App</h3>
                <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                  Designed and developed a full 3D interactive model of the entire campus using Unity3D. Built and integrated a custom API to connect the model with real-time campus data. Visualized live power consumption and carbon emissions within the 3D environment.
                </p>
              </div>
              <div className="mt-auto pt-4 border-t border-slate-100">
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-xs font-medium border border-blue-100">Unity3D</span>
                  <span className="px-3 py-1 bg-green-50 text-green-600 rounded-full text-xs font-medium border border-green-100">API</span>
                  <span className="px-3 py-1 bg-teal-50 text-teal-600 rounded-full text-xs font-medium border border-teal-100">Data Visualization</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 flex flex-col h-full group">
              <div className="mb-4">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">Underwater Robot Project</h3>
                <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                  Developed a 3D visualization and control interface for an underwater cleaning robot. Built a real-time data-driven system to display the robot and water pump operations in an interactive 3D environment. Designed and implemented the API to seamlessly connect live sensor data.
                </p>
              </div>
              <div className="mt-auto pt-4 border-t border-slate-100">
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-xs font-medium border border-blue-100">Robotics</span>
                  <span className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-xs font-medium border border-indigo-100">3D Visualization</span>
                  <span className="px-3 py-1 bg-gray-50 text-gray-600 rounded-full text-xs font-medium border border-gray-100">Backend</span>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['C++', 'C#', 'C', 'Python', 'JavaScript', 'TypeScript', 'HTML', 'CSS', 'ReactJS', 'SQL', 'MongoDB'].map((skill) => (
                      <span key={skill} className="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-100 hover:bg-blue-100 transition-colors cursor-default">{skill}</span>
                    ))}
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Unity3D', 'Unreal Engine', 'Blender', 'FL Studio', 'VS Code', 'MS Office', 'Photoshop', 'Premiere Pro', 'Git'].map((skill) => (
                      <span key={skill} className="px-3 py-1 bg-green-50 text-green-700 rounded-full text-sm font-medium border border-green-100 hover:bg-green-100 transition-colors cursor-default">{skill}</span>
                    ))}
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['PyTorch', 'TensorFlow', 'Scikit-learn', 'Stable Diffusion', 'Computer Vision', 'Reinforcement Learning', 'Deep Learning', 'LLMs', 'Data Mining'].map((skill) => (
                      <span key={skill} className="px-3 py-1 bg-purple-50 text-purple-700 rounded-full text-sm font-medium border border-purple-100 hover:bg-purple-100 transition-colors cursor-default">{skill}</span>
                    ))}
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Singing', 'Gaming', 'Writing Songs', 'Making Music', 'Partying', 'Chatting', 'Pop Culture', 'Movies'].map((interest) => (
                    <span key={interest} className="px-3 py-1 bg-rose-50 text-rose-700 rounded-full text-sm font-medium border border-rose-100 hover:bg-rose-100 transition-colors cursor-default">{interest}</span>
                  ))}
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group md:col-span-2">
              <div className="flex items-start gap-4">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">May 2025 – July 2025</span>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">May 2024 – June 2024</span>
              </div>
              <p className="text-slate-500 mb-4 flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-slate-400 rounded-full"></span>
                Tongren, China
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <span className="px-4 py-1 bg-slate-100 text-slate-600 rounded-full text-sm font-medium mt-2 md:mt-0 w-fit">December 2023 – May 2024</span>
              </div>
              <ul className="text-slate-700 space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
     ...
     <section id="contact" className="py-20 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 flex-wrap">
            <a href="mailto:ghanibhutigogoi@gmail.com"
               className="flex items-center justify-center gap-3 px-8 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-blue-200 hover:-translate-y-1">
              <Mail size={20} />
              <span className="font-semibold">Email Me</span>
            </a>
            <a href="https://www.linkedin.com/in/ghanibhuti-gogoi-365820229/"
               className="flex items-center justify-center gap-3 px-8 py-4 bg-white border border-slate-200 text-slate-700 rounded-xl hover:border-blue-300 hover:text-blue-600 transition-all shadow-sm hover:shadow-lg hover:-translate-y-1">
              <Linkedin size={20} />
              <span className="font-semibold">LinkedIn</span>
            </a>
            <a href="https://www.instagram.com/ghanibhuti_gogoi/"
               className="flex items-center justify-center gap-3 px-8 py-4 bg-white border border-slate-200 text-slate-700 rounded-xl hover:border-pink-300 hover:text-pink-600 transition-all shadow-sm hover:shadow-lg hover:-translate-y-1">
              <Instagram size={20} />
              <span className="font-semibold">Instagram</span>
            </a>
            <a href="https://wa.me/918486941868"
               className="flex items-center justify-center gap-3 px-8 py-4 bg-white border border-slate-200 text-slate-700 rounded-xl hover:border-green-300 hover:text-green-600 transition-all shadow-sm hover:shadow-lg hover:-translate-y-1">
              {/* WhatsApp SVG icon */}
